...
void MX_DMA_Init(void)
{
  ...
  __NVIC_SetPriority(DMA1_Stream5_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(),0, 0));
  __NVIC_EnableIRQ(DMA1_Stream5_IRQn);

  __NVIC_SetPriority(DMA1_Stream6_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(),0, 0));
  __NVIC_EnableIRQ(DMA1_Stream6_IRQn);

  __NVIC_SetPriority(DMA2_Stream2_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(),0, 0));
  __NVIC_EnableIRQ(DMA2_Stream2_IRQn);

  __NVIC_SetPriority(DMA2_Stream7_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(),0, 0));
