# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c" 2
# 21 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c"
...
# 22 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c" 2
...
# 23 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c" 2

# 1 "../Core/Inc\\stm32_assert.h" 1
# 43 "../Core/Inc\\stm32_assert.h"
  void assert_failed(uint8_t* file, uint32_t line);
# 25 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c" 2
# 155 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c"
uint32_t LL_DMA_DeInit(DMA_TypeDef *DMAx, uint32_t Stream)
{
  ...
  ((((((DMAx) == ((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL))) && (((Stream) == 0x00000000U) || ((Stream) == 0x00000001U) || ((Stream) == 0x00000002U) || ((Stream) == 0x00000003U) || ((Stream) == 0x00000004U) || ((Stream) == 0x00000005U) || ((Stream) == 0x00000006U) || ((Stream) == 0x00000007U) || ((Stream) == 0xFFFF0000U))) || (((DMAx) == ((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL))) && (((Stream) == 0x00000000U) || ((Stream) == 0x00000001U) || ((Stream) == 0x00000002U) || ((Stream) == 0x00000003U) || ((Stream) == 0x00000004U) || ((Stream) == 0x00000005U) || ((Stream) == 0x00000006U) || ((Stream) == 0x00000007U) || ((Stream) == 0xFFFF0000U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 161));
...
# 284 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c"
uint32_t LL_DMA_Init(DMA_TypeDef *DMAx, uint32_t Stream, LL_DMA_InitTypeDef *DMA_InitStruct)
{

  ((((((DMAx) == ((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL))) && (((Stream) == 0x00000000U) || ((Stream) == 0x00000001U) || ((Stream) == 0x00000002U) || ((Stream) == 0x00000003U) || ((Stream) == 0x00000004U) || ((Stream) == 0x00000005U) || ((Stream) == 0x00000006U) || ((Stream) == 0x00000007U) || ((Stream) == 0xFFFF0000U))) || (((DMAx) == ((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL))) && (((Stream) == 0x00000000U) || ((Stream) == 0x00000001U) || ((Stream) == 0x00000002U) || ((Stream) == 0x00000003U) || ((Stream) == 0x00000004U) || ((Stream) == 0x00000005U) || ((Stream) == 0x00000006U) || ((Stream) == 0x00000007U) || ((Stream) == 0xFFFF0000U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 287));


  (((((DMA_InitStruct->Direction) == 0x00000000U) || ((DMA_InitStruct->Direction) == (0x1UL << (6U))) || ((DMA_InitStruct->Direction) == (0x2UL << (6U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 290));
  (((((DMA_InitStruct->Mode) == 0x00000000U) || ((DMA_InitStruct->Mode) == (0x1UL << (8U))) || ((DMA_InitStruct->Mode) == (0x1UL << (5U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 291));
  (((((DMA_InitStruct->PeriphOrM2MSrcIncMode) == (0x1UL << (9U))) || ((DMA_InitStruct->PeriphOrM2MSrcIncMode) == 0x00000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 292));
  (((((DMA_InitStruct->MemoryOrM2MDstIncMode) == (0x1UL << (10U))) || ((DMA_InitStruct->MemoryOrM2MDstIncMode) == 0x00000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 293));
  (((((DMA_InitStruct->PeriphOrM2MSrcDataSize) == 0x00000000U) || ((DMA_InitStruct->PeriphOrM2MSrcDataSize) == (0x1UL << (11U))) || ((DMA_InitStruct->PeriphOrM2MSrcDataSize) == (0x2UL << (11U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 294));
  (((((DMA_InitStruct->MemoryOrM2MDstDataSize) == 0x00000000U) || ((DMA_InitStruct->MemoryOrM2MDstDataSize) == (0x1UL << (13U))) || ((DMA_InitStruct->MemoryOrM2MDstDataSize) == (0x2UL << (13U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 295));
  ((((DMA_InitStruct->NbData) <= 0x0000FFFFU)) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 296));
  (((((DMA_InitStruct->Channel) == 0x00000000U) || ((DMA_InitStruct->Channel) == 0x02000000U) || ((DMA_InitStruct->Channel) == 0x04000000U) || ((DMA_InitStruct->Channel) == (0x02000000U | 0x04000000U)) || ((DMA_InitStruct->Channel) == 0x08000000U) || ((DMA_InitStruct->Channel) == (0x08000000U | 0x02000000U)) || ((DMA_InitStruct->Channel) == (0x08000000U | 0x04000000U)) || ((DMA_InitStruct->Channel) == (0x08000000U | 0x04000000U | 0x02000000U)))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 297));
  (((((DMA_InitStruct->Priority) == 0x00000000U) || ((DMA_InitStruct->Priority) == (0x1UL << (16U))) || ((DMA_InitStruct->Priority) == (0x2UL << (16U))) || ((DMA_InitStruct->Priority) == (0x3UL << (16U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 298));
  (((((DMA_InitStruct->FIFOMode) == 0x00000000U ) || ((DMA_InitStruct->FIFOMode) == (0x1UL << (2U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 299));


  if(DMA_InitStruct->FIFOMode != 0x00000000U)
  {
    (((((DMA_InitStruct->FIFOThreshold) == 0x00000000U) || ((DMA_InitStruct->FIFOThreshold) == (0x1UL << (0U))) || ((DMA_InitStruct->FIFOThreshold) == (0x2UL << (0U))) || ((DMA_InitStruct->FIFOThreshold) == (0x3UL << (0U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 304));
    (((((DMA_InitStruct->MemBurst) == 0x00000000U) || ((DMA_InitStruct->MemBurst) == (0x1UL << (23U))) || ((DMA_InitStruct->MemBurst) == (0x2UL << (23U))) || ((DMA_InitStruct->MemBurst) == ((0x1UL << (23U)) | (0x2UL << (23U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 305));
    (((((DMA_InitStruct->PeriphBurst) == 0x00000000U) || ((DMA_InitStruct->PeriphBurst) == (0x1UL << (21U))) || ((DMA_InitStruct->PeriphBurst) == (0x2UL << (21U))) || ((DMA_InitStruct->PeriphBurst) == ((0x1UL << (21U)) | (0x2UL << (21U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c", 306));
  }
# 321 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c"
