# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2
# 19 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
# 1 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_utils.h" 1
# 40 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_utils.h"
...
# 41 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_utils.h" 2
...
# 20 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2
...
# 21 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2
...
# 22 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2
...
# 23 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2

# 1 "../Core/Inc\\stm32_assert.h" 1
# 43 "../Core/Inc\\stm32_assert.h"
  void assert_failed(uint8_t* file, uint32_t line);
# 25 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c" 2
# 232 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency,
                                               LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct);
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct);
static ErrorStatus UTILS_PLL_IsBusy(void);
# 257 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
void LL_Init1msTick(uint32_t HCLKFrequency)
{

  LL_InitTick(HCLKFrequency, 1000U);
}
# 273 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
void LL_mDelay(uint32_t Delay)
{
...
# 323 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
void LL_SetSystemCoreClock(uint32_t HCLKFrequency)
{

  SystemCoreClock = HCLKFrequency;
}
# 338 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
ErrorStatus LL_SetFlashLatency(uint32_t HCLK_Frequency)
{
  uint32_t timeout;
  uint32_t getlatency;
  ...
  {
    if(LL_PWR_GetRegulVoltageScaling() == ((0x1UL << (14U))))
    {
...
# 444 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
# 483 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
ErrorStatus LL_PLL_ConfigSystemClock_HSI(LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct,
                                         LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  if(UTILS_PLL_IsBusy() == SUCCESS)
  {
    ...
    pllfreq = UTILS_GetPLLOutputFrequency(16000000, UTILS_PLLInitStruct);
...
# 540 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
ErrorStatus LL_PLL_ConfigSystemClock_HSE(uint32_t HSEFrequency, uint32_t HSEBypass,
                                         LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  (((((HSEFrequency) >= 4000000U) && ((HSEFrequency) <= 26000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 547));
  (((((HSEBypass) == 0x00000001U) || ((HSEBypass) == 0x00000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 548));
...
# 611 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct)
{
  uint32_t pllfreq = 0U;


  (((((UTILS_PLLInitStruct->PLLM) == ((0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)))) || ((UTILS_PLLInitStruct->PLLM) == ((0x20UL << (0U)) | (0x10UL << (0U)) | (0x08UL << (0U)) | (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 616));
  ((((50U <= (UTILS_PLLInitStruct->PLLN)) && ((UTILS_PLLInitStruct->PLLN) <= 432U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 617));
  (((((UTILS_PLLInitStruct->PLLP) == 0x00000000U) || ((UTILS_PLLInitStruct->PLLP) == (0x1UL << (16U))) || ((UTILS_PLLInitStruct->PLLP) == (0x2UL << (16U))) || ((UTILS_PLLInitStruct->PLLP) == ((0x2UL << (16U)) | (0x1UL << (16U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 618));



  pllfreq = PLL_InputFrequency / (UTILS_PLLInitStruct->PLLM & ((0x3FUL << (0U)) >> (0U)));
  ((((950000U <= (pllfreq)) && ((pllfreq) <= 2100000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 623));


  pllfreq = pllfreq * (UTILS_PLLInitStruct->PLLN & ((0x1FFUL << (6U)) >> (6U)));
  ((((100000000U <= (pllfreq)) && ((pllfreq) <= 432000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 627));


  pllfreq = pllfreq / (((UTILS_PLLInitStruct->PLLP >> (16U)) + 1) * 2);
  ((((LL_PWR_GetRegulVoltageScaling() == ((0x1UL << (14U)))) ? ((pllfreq) <= 168000000U) : ((pllfreq) <= 144000000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 631));
...
# 663 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
...
# 681 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c"
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  uint32_t hclk_frequency = 0U;

  (((((UTILS_ClkInitStruct->AHBCLKDivider) == 0x00000000U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x00000080U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x00000090U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000A0U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000B0U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000C0U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000D0U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000E0U) || ((UTILS_ClkInitStruct->AHBCLKDivider) == 0x000000F0U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 686));
  (((((UTILS_ClkInitStruct->APB1CLKDivider) == 0x00000000U) || ((UTILS_ClkInitStruct->APB1CLKDivider) == 0x00001000U) || ((UTILS_ClkInitStruct->APB1CLKDivider) == 0x00001400U) || ((UTILS_ClkInitStruct->APB1CLKDivider) == 0x00001800U) || ((UTILS_ClkInitStruct->APB1CLKDivider) == 0x00001C00U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 687));
  (((((UTILS_ClkInitStruct->APB2CLKDivider) == 0x00000000U) || ((UTILS_ClkInitStruct->APB2CLKDivider) == 0x00008000U) || ((UTILS_ClkInitStruct->APB2CLKDivider) == 0x0000A000U) || ((UTILS_ClkInitStruct->APB2CLKDivider) == 0x0000C000U) || ((UTILS_ClkInitStruct->APB2CLKDivider) == 0x0000E000U))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c", 688));
