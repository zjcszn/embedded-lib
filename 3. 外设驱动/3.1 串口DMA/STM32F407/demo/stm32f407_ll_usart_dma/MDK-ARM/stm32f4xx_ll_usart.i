# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c" 2
# 22 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
# 1 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_usart.h" 1
# 28 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_usart.h"
...
# 29 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_usart.h" 2
...
# 23 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c" 2
...
# 24 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c" 2
...
# 25 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c" 2

# 1 "../Core/Inc\\stm32_assert.h" 1
# 43 "../Core/Inc\\stm32_assert.h"
  void assert_failed(uint8_t* file, uint32_t line);
# 27 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c" 2
# 124 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
ErrorStatus LL_USART_DeInit(USART_TypeDef *USARTx)
{
  ErrorStatus status = SUCCESS;


  (((((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4400UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4800UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4C00UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x5000UL))) || ((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 129));

  if (USARTx == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {

    LL_APB2_GRP1_ForceReset((0x1UL << (4U)));


    LL_APB2_GRP1_ReleaseReset((0x1UL << (4U)));
  }
  ...
  else if (USARTx == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL)))
  {

    LL_APB2_GRP1_ForceReset((0x1UL << (5U)));


    LL_APB2_GRP1_ReleaseReset((0x1UL << (5U)));
  }
  ...
  else if (USARTx == ((USART_TypeDef *) (0x40000000UL + 0x5000UL)))
  {

    LL_APB1_GRP1_ForceReset((0x1UL << (20U)));


    LL_APB1_GRP1_ReleaseReset((0x1UL << (20U)));
  }
# 227 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
  else
  {
    status = ERROR;
  }
...
# 248 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
ErrorStatus LL_USART_Init(USART_TypeDef *USARTx, LL_USART_InitTypeDef *USART_InitStruct)
{
  ...
  (((((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4400UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4800UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4C00UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x5000UL))) || ((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 255));
  ((((USART_InitStruct->BaudRate) <= 12500000U)) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 256));
  (((((USART_InitStruct->DataWidth) == 0x00000000U) || ((USART_InitStruct->DataWidth) == (0x1UL << (12U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 257));
  (((((USART_InitStruct->StopBits) == (0x1UL << (12U))) || ((USART_InitStruct->StopBits) == 0x00000000U) || ((USART_InitStruct->StopBits) == ((0x1UL << (12U)) | (0x2UL << (12U)))) || ((USART_InitStruct->StopBits) == (0x2UL << (12U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 258));
  (((((USART_InitStruct->Parity) == 0x00000000U) || ((USART_InitStruct->Parity) == (0x1UL << (10U))) || ((USART_InitStruct->Parity) == ((0x1UL << (10U)) | (0x1UL << (9U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 259));
  (((((USART_InitStruct->TransferDirection) == 0x00000000U) || ((USART_InitStruct->TransferDirection) == (0x1UL << (2U))) || ((USART_InitStruct->TransferDirection) == (0x1UL << (3U))) || ((USART_InitStruct->TransferDirection) == ((0x1UL << (3U)) |(0x1UL << (2U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 260));
  (((((USART_InitStruct->HardwareFlowControl) == 0x00000000U) || ((USART_InitStruct->HardwareFlowControl) == (0x1UL << (8U))) || ((USART_InitStruct->HardwareFlowControl) == (0x1UL << (9U))) || ((USART_InitStruct->HardwareFlowControl) == ((0x1UL << (8U)) | (0x1UL << (9U)))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 261));
  (((((USART_InitStruct->OverSampling) == 0x00000000U) || ((USART_InitStruct->OverSampling) == (0x1UL << (15U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 262));
...
# 286 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
...
# 354 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
    else
    {
        ...
        && (USART_InitStruct->BaudRate != 0U))
    {
      ...
      ((((USARTx->BRR) >= 16U)) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 373));
    }
  }
...
# 388 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
void LL_USART_StructInit(LL_USART_InitTypeDef *USART_InitStruct)
{
...
# 412 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
ErrorStatus LL_USART_ClockInit(USART_TypeDef *USARTx, LL_USART_ClockInitTypeDef *USART_ClockInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  (((((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4400UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4800UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4C00UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x5000UL))) || ((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 417));
  (((((USART_ClockInitStruct->ClockOutput) == 0x00000000U) || ((USART_ClockInitStruct->ClockOutput) == (0x1UL << (11U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 418));
  ...
  if (LL_USART_IsEnabled(USARTx) == 0U)
  {
    ...
    else
    {
      ...
      (((((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4400UL))) || ((USARTx) == ((USART_TypeDef *) (0x40000000UL + 0x4800UL))) || ((USARTx) == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 436));


      (((((USART_ClockInitStruct->ClockPolarity) == 0x00000000U) || ((USART_ClockInitStruct->ClockPolarity) == (0x1UL << (10U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 439));
      (((((USART_ClockInitStruct->ClockPhase) == 0x00000000U) || ((USART_ClockInitStruct->ClockPhase) == (0x1UL << (9U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 440));
      (((((USART_ClockInitStruct->LastBitClockPulse) == 0x00000000U) || ((USART_ClockInitStruct->LastBitClockPulse) == (0x1UL << (8U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c", 441));
# 450 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c"
