# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c" 2
# 21 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c"
# 1 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_exti.h" 1
# 28 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_exti.h"
...
# 29 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_exti.h" 2
...
# 22 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c" 2

# 1 "../Core/Inc\\stm32_assert.h" 1
# 43 "../Core/Inc\\stm32_assert.h"
  void assert_failed(uint8_t* file, uint32_t line);
# 24 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c" 2
# 79 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c"
uint32_t LL_EXTI_DeInit(void)
{

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR) = ((0x00000000U)));

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR) = ((0x00000000U)));

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR) = ((0x00000000U)));

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR) = ((0x00000000U)));

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->SWIER) = ((0x00000000U)));

  ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR) = ((0x00FFFFFFU)));

  return SUCCESS;
}
# 104 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c"
uint32_t LL_EXTI_Init(LL_EXTI_InitTypeDef *EXTI_InitStruct)
{
  ErrorStatus status = SUCCESS;

  (((((EXTI_InitStruct->Line_0_31) & ~(0x7FFFFFUL << (0U))) == 0x00000000U)) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c", 108));
  (((((EXTI_InitStruct->LineCommand) == DISABLE) || ((EXTI_InitStruct->LineCommand) == ENABLE))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c", 109));
  (((((EXTI_InitStruct->Mode) == ((uint8_t)0x00U)) || ((EXTI_InitStruct->Mode) == ((uint8_t)0x01U)) || ((EXTI_InitStruct->Mode) == ((uint8_t)0x02U)))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c", 110));


  if (EXTI_InitStruct->LineCommand != DISABLE)
  {
    (((((EXTI_InitStruct->Trigger) == ((uint8_t)0x00U)) || ((EXTI_InitStruct->Trigger) == ((uint8_t)0x01U)) || ((EXTI_InitStruct->Trigger) == ((uint8_t)0x02U)) || ((EXTI_InitStruct->Trigger) == ((uint8_t)0x03U)))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c", 115));
