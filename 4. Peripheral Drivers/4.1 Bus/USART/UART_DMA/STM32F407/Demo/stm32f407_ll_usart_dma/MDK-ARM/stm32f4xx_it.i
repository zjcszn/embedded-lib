...
# 6 "../User/BSP\\dev_usart.h" 2
# 21 "../User/BSP\\dev_usart.h"
enum ENUM_UsartDev {
  DEV_USART1,
  DEV_USART2,
  DEV_USART_COUNT,
...
void DMA1_Stream5_IRQHandler(void)
{
  ...
  if (LL_DMA_IsEnabledIT_HT(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)), 0x00000005U) && LL_DMA_IsActiveFlag_HT5(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)))) {
    usart_dmarx_ht_isr(DEV_USART2);
    LL_DMA_ClearFlag_HT5(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)));
  }

  if (LL_DMA_IsEnabledIT_TC(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)), 0x00000005U) && LL_DMA_IsActiveFlag_TC5(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)))) {
    usart_dmarx_tc_isr(DEV_USART2);
    LL_DMA_ClearFlag_TC5(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)));
  }
...
void DMA1_Stream6_IRQHandler(void)
{
  ...
  if (LL_DMA_IsEnabledIT_TC(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)), 0x00000006U) && LL_DMA_IsActiveFlag_TC6(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL)))) {
    usart_dmatx_tc_isr(DEV_USART2);
...
void USART1_IRQHandler(void)
{
    ...
    if (LL_USART_IsEnabledIT_IDLE(((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) && LL_USART_IsActiveFlag_IDLE(((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))))
    {
        usart_dmarx_idle_isr(DEV_USART1);
        LL_USART_ClearFlag_IDLE(((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)));
    }
...
void USART2_IRQHandler(void)
{
    ...
    if (LL_USART_IsEnabledIT_IDLE(((USART_TypeDef *) (0x40000000UL + 0x4400UL))) && LL_USART_IsActiveFlag_IDLE(((USART_TypeDef *) (0x40000000UL + 0x4400UL))))
    {
        usart_dmarx_idle_isr(DEV_USART2);
        LL_USART_ClearFlag_IDLE(((USART_TypeDef *) (0x40000000UL + 0x4400UL)));
    }
...
void DMA2_Stream2_IRQHandler(void)
{
  ...
  if (LL_DMA_IsEnabledIT_HT(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)), 0x00000002U) && LL_DMA_IsActiveFlag_HT2(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)))) {
    usart_dmarx_ht_isr(DEV_USART1);
    LL_DMA_ClearFlag_HT2(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)));
  }

  if (LL_DMA_IsEnabledIT_TC(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)), 0x00000002U) && LL_DMA_IsActiveFlag_TC2(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)))) {
    usart_dmarx_tc_isr(DEV_USART1);
    LL_DMA_ClearFlag_TC2(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)));
  }
...
void DMA2_Stream7_IRQHandler(void)
{
  ...
  if (LL_DMA_IsEnabledIT_TC(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)), 0x00000007U) && LL_DMA_IsActiveFlag_TC7(((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)))) {
    usart_dmatx_tc_isr(DEV_USART1);
