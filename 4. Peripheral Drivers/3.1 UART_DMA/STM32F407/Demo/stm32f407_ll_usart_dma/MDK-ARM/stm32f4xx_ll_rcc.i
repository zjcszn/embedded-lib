# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c" 2
# 20 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
...
# 28 "../Drivers/STM32F4xx_HAL_Driver/Inc\\stm32f4xx_ll_rcc.h" 2
...
# 21 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c" 2

# 1 "../Core/Inc\\stm32_assert.h" 1
# 43 "../Core/Inc\\stm32_assert.h"
  void assert_failed(uint8_t* file, uint32_t line);
# 23 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c" 2
# 114 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
...
# 144 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t RCC_PLLI2S_GetFreqDomain_I2S(void);
# 184 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
ErrorStatus LL_RCC_DeInit(void)
{
  ...
  vl_mask = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CR));


  ((vl_mask) &= ~(((0x1UL << (16U)) | (0x1UL << (18U)) | (0x1UL << (24U)) | (0x1UL << (19U)))));
# 212 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
  ((vl_mask) &= ~((0x1UL << (26U))));
  ...
  ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR) = ((0x20003000U)));
# 239 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
...
# 302 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
void LL_RCC_GetSystemClocksFreq(LL_RCC_ClocksTypeDef *RCC_Clocks)
{
...
# 369 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t LL_RCC_GetI2SClockFreq(uint32_t I2SxSource)
{
  uint32_t i2s_frequency = 0x00000000U;


  (((((I2SxSource) == (0x1UL << (23U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c", 374));
  ...
  if (I2SxSource == (0x1UL << (23U)))
  {
    ...
    switch (LL_RCC_GetI2SClockSource(I2SxSource))
    {
      ...
      case 0x00000000U:
        ...
        break;
# 419 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
      case (0x1UL << (23U)):
      default:
        i2s_frequency = 12288000;
        break;
    }
  }
# 473 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
  return i2s_frequency;
}
# 681 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t LL_RCC_GetSDIOClockFreq(uint32_t SDIOxSource)
{
  uint32_t SDIO_frequency = 0x00000000U;


  (((((SDIOxSource) == (0xFUL << (24U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c", 686));

  if (SDIOxSource == (0xFUL << (24U)))
  {
# 733 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
...
# 752 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
  uint32_t rng_frequency = 0x00000000U;


  (((((RNGxSource) == (0xFUL << (24U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c", 757));
# 791 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
  if (LL_RCC_PLL_IsReady())
  {
...
# 847 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
  uint32_t usb_frequency = 0x00000000U;


  (((((USBxSource) == (0xFUL << (24U))))) ? (void)0U : assert_failed((uint8_t *)"../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c", 852));
# 887 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
  if (LL_RCC_PLL_IsReady())
  {
...
# 1118 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t RCC_GetSystemClockFreq(void)
{
...
# 1226 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
...
# 1573 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c"
uint32_t RCC_PLLI2S_GetFreqDomain_I2S(void)
{
